...
// The body tag must be available early in the processing.
document.addEventListener('DOMContentLoaded', function () {
  'use strict';
  var ns, MS_PER_SECOND, canvas, ctx, lastTime,
    update, render, reset, updateEntities, renderEntities, rdyEvnt;

  // Create the functions needed for the animation engine in the local function
  // closure scope.  Nothing NEEDS to be in the global namespace.
  ...
  ////////////////////////////////////////////////
  // Start of the actual program code execution //
  ////////////////////////////////////////////////

  // Initialize a few constants
  MS_PER_SECOND = 1000;
  /* The original 'this' value previously used is no longer the correct context.
   * It used to be 'window', but is now 'document' due to using addEventListener
   * to start things up.  Explicitly reference through 'window' instead.
   */
  ...
  /* Start the game engine processing loop.
   *
